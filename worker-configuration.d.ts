/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c0266b9435ca17ee5dbbef5e9a82edc6)
// Runtime types generated with workerd@1.20260219.0 2024-04-03 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		DB: D1Database;
		FRONTEND_URL: "https://free2free.pages.dev";
		JWT_SECRET: string;
		SESSION_KEY: string;
		FACEBOOK_KEY: string;
	...
	interface Env {
		...
		ENVIRONMENT: string;
		DB: D1Database;
		FRONTEND_URL: "https://free2free.pages.dev" | "http://localhost:3000";
	}
}
